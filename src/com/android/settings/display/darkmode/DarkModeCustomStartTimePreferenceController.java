...
public class DarkModeCustomStartTimePreferenceController extends BasePreferenceController {

    private UiModeManager mUiModeManager;
    private DarkModeTimeFormatter mTimeFormatter;

    public DarkModeCustomStartTimePreferenceController(Context context, String key) {
        super(context, key);
